                                ...
                                <Div img={post.imgURL[0]} className={`w-[96%] h-52 rounded smin:w-[46%] `} key={post._id}>
                                    <Link to={`/post/${post._id}`} key={post._id}>
                                        <div className='w-full h-full bg-[rgba(0,0,0,.3)] flex flex-col justify-end'>
                                            ...
                                            <p className='text-white drop-shadow-black line-clamp-3 p-2 pb-[0.2rem] font-light group-hover:underline group-hover:underline-offset-2'>{post.description}</p>
                                        </div>
                                    </Link>
                                </Div>
                            )
